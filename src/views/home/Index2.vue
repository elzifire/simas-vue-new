                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3 mt-4">
                            <h4 class="mb-2 mt-2 ls1 text-uppercase fw-bold">Galeri Kegiatan</h4>
                            <div class="line line-xs line-market"></div>
                        </div>
...
<div v-if="moneys !== null">
    <div class="card border-0 shadow-sm rounded-lg mb-3">
        <div class="card-body">
            <h6>Uang Masuk: {{ moneys.masuk }}</h6>
            <h6>Uang Keluar: {{ moneys.keluar }}</h6>
    ...
    export default {
        ...
        setup() {
            ...
            onMounted(async () => {
                ...
                //     })
                  try {
                    const payload = await axios.get('/api/homepage/money');
                    moneys.value = payload.data;
                  } catch (error) {
                    console.log(error);
                  }
